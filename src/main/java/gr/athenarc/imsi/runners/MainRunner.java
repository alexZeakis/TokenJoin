	...
	public static void main(String[] args) {
		try {
			...
			if (similarity.equals("jaccard")) {
				...
				switch (model) {
				case "SM": // SM;
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.jaccard.Silkmoth(
							new ThresholdCompetitor("SM", false, ver));
					alg.selfJoin(collection, delta);
					break;
				case "TJ": // TJB
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.jaccard.TokenJoin(
				...
				case "TJPJ": // TJPJ
					...
					break;
				case "TJV": // TJV
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.jaccard.TokenJoinV(
							new ThresholdCompetitor("TJPJ - VUL", true, true, 2, true));
					alg.selfJoin(collection, delta);
					break;
				case "TJK": // TJK
					alg = new gr.athenarc.imsi.simjoin.alg.topk.jaccard.TokenJoin(
							new TopkCompetitor("TJK", 2, 0.90, 0.01, 2, 0.4));
					alg.selfJoin(collection, k);
					break;
				case "OT":
					new gr.athenarc.imsi.simjoin.alg.topk.jaccard.Fixed().selfJoinFixed(collection, k, delta);
					break;
				case "SMK":
					alg = new gr.athenarc.imsi.simjoin.alg.topk.jaccard.Silkmoth(
							new TopkCompetitor("SMK", 2, 0.90, 0.01, 2, 0.4));
					alg.selfJoin(collection, k);
					break;
				case "FJK":
					alg = new gr.athenarc.imsi.simjoin.alg.topk.jaccard.TopkJoin(
				...
				switch (model) {
				case "SM": // SM;
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.edit.Silkmoth(
							new ThresholdCompetitor("SM", false, ver));
					alg.selfJoin(collection, delta);
					break;
				case "TJ": // TJB
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.edit.TokenJoin(
							new ThresholdCompetitor("TJB", false, false, ver, true));
					alg.selfJoin(collection, delta);
					break;
				case "TJP": // TJP
				...
				case "TJPJ": // TJPJ
					...
					break;
				case "TJV": // TJV
					alg = new gr.athenarc.imsi.simjoin.alg.threshold.edit.TokenJoinV(
							new ThresholdCompetitor("TJPJ - VUL", true, true, 2, true));
					alg.selfJoin(collection, delta);
					break;
				case "TJK": // TJK
					alg = new gr.athenarc.imsi.simjoin.alg.topk.edit.TokenJoin(
							new TopkCompetitor("TJK", 2, 0.90, 0.01, 2, 0.4));
					alg.selfJoin(collection, k);
					break;
				case "OT":
					new gr.athenarc.imsi.simjoin.alg.topk.edit.Fixed().selfJoinFixed(collection, k, delta);
					break;
				case "SMK":
					alg = new gr.athenarc.imsi.simjoin.alg.topk.edit.Silkmoth(
							new TopkCompetitor("SMK", 2, 0.90, 0.01, 2, 0.4));
					alg.selfJoin(collection, k);
					break;
				case "FJK":
					alg = new gr.athenarc.imsi.simjoin.alg.topk.edit.TopkJoin(
							new TopkCompetitor("FJK", 2, 0.90, 0.01, 2, 0.4));
					alg.selfJoin(collection, k);
					break;
				}
