...
import eu.smartdatalake.simjoin.alg.topk.edit.Fixed;
import eu.smartdatalake.simjoin.alg.topk.edit.TopkJoin;
import eu.smartdatalake.simjoin.alg.topk.edit.Silkmoth;
import eu.smartdatalake.simjoin.alg.topk.edit.TokenJoin;
...
/**
 * Experiment for Edit TopK.
 *
 */
public class TopKEditK {
	protected static final Logger logger = LogManager.getLogger(TopKEditK.class);
